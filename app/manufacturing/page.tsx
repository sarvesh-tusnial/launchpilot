    ...
    <div style={{ background:'#05050A', minHeight:'100vh', color:'#E8E6E0', fontFamily:'DM Sans,sans-serif' }}>
      ...
      <nav className="nav-wrap" style={{ position:'fixed', top:0, left:0, right:0, zIndex:200, display:'flex', alignItems:'center', justifyContent:'space-between', height:'68px', background:'rgba(5,5,10,0.94)', backdropFilter:'blur(24px)', borderBottom:'1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div style={{ display:'flex', gap:'10px', alignItems:'center' }}>
          ...
          <Link href="/apply" style={{ fontSize:'13px', padding:'10px 16px', borderRadius:'8px', background:MFG, color:'#fff', fontWeight:'700', textDecoration:'none', whiteSpace:'nowrap' }}>Apply Now →</Link>
      ...
      <section style={{ padding:'80px 24px', background:'#060608', borderTop:'1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth:'1160px', margin:'0 auto' }}>
          ...
          <div style={{ marginBottom:'56px' }}>
            <div className="label" style={{ marginBottom:'16px', color:MFG_BRIGHT }}>Program Committee</div>
            <h2 className="pf" style={{ fontSize:'clamp(28px,4.5vw,52px)', fontWeight:'800', letterSpacing:'-0.03em', color:'#F0EDE6', lineHeight:'1.1', marginBottom:'16px' }}>
              School committee backed by<br /><span style={{ color:MFG_BRIGHT }}>real-world leaders in manufacturing.</span>
            </h2>
            <p style={{ fontSize:'16px', color:'#888', lineHeight:'1.7', maxWidth:'580px' }}>
              Every program, competency and assessment in this school has been designed with — and validated by — practitioners who have run plants, fixed supply chains and led operations across Asia, the Middle East and beyond.
            </p>
          </div>

          {/* 10 committee members — 5-col grid */}
          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'16px' }} className="committee-grid">
            {[
              { name:'Sarvesh Tusnial',       role:'School Associate Director · ex EY · NTU Singapore',  tag:'School Director',  img:'/images/mentors/sarvesh-tusnial.jpg' },
              { name:'Jason Kraus',        role:'Founder, Prepare4VC · Partner, EQx Fund',                   tag:'VC & Strategy',    img:'/images/mentors/jason-kraus.jpg' },
              { name:'Renuka Belwalkar',   role:'Investor · Forbes Under 30 Scholar',                        tag:'Investment',       img:'/images/mentors/renuka-belwalkar.jpg' },
              { name:'Yash Shah',          role:'GenAI Head India & SEA · AWS',                              tag:'Industrial AI',    img:'/images/mentors/yash-shah.jpg' },
              { name:'Andrew Chow',        role:'Co-Founder, Asia Pro Ventures · NTU',                       tag:'Operations',       img:'/images/mentors/andrew-chow.jpg' },
              { name:'Daniel Ling',        role:'ex-VP Design, Lazada & DBS · NUS',                         tag:'Leadership',       img:'/images/mentors/daniel-ling.jpg' },
              { name:'Shavin Goswami',     role:'Global Risk Ops, Meta · ex-EY Consulting',                 tag:'Risk & Ops',       img:'/images/mentors/shavin-goswami.jpg' },
              { name:'Rajesh Setty',       role:'19x Author · Mentor at Founder Institute',                 tag:'Strategy',         img:'/images/mentors/rajesh-shetty.jpg' },
              ...
              { name:'Justin Strackany',   role:'LP at GTMFund · 3 exits (SecureLink/Vista)',               tag:'Growth',           img:'/images/mentors/justin-strackany.jpg' },
            ].map(m => (
              <div key={m.name} style={{ display:'flex', flexDirection:'column', alignItems:'center', textAlign:'center', gap:'12px' }}>
                {/* Photo */}
                <div style={{ position:'relative', width:'88px', height:'88px', borderRadius:'50%', overflow:'hidden', border:`2px solid ${MFG}30`, background:`${MFG}10`, flexShrink:0 }}>
                  <img
                    src={m.img}
                    alt={m.name}
                ...
                {/* Tag */}
                <div style={{ fontFamily:'DM Mono,monospace', fontSize:'8px', letterSpacing:'0.14em', textTransform:'uppercase', color:MFG, background:`${MFG}12`, border:`1px solid ${MFG}25`, padding:'3px 10px', borderRadius:'100px' }}>{m.tag}</div>
                {/* Name */}
      ...
      <section style={{ padding:'100px 24px', background:'#05050A', borderTop:'1px solid rgba(255,255,255,0.05)', position:'relative', overflow:'hidden' }}>
        <div style={{ position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)', width:'700px', height:'500px', background:`radial-gradient(ellipse,${MFG}08 0%,transparent 65%)`, pointerEvents:'none' }} />
        <div style={{ maxWidth:'1160px', margin:'0 auto', position:'relative' }}>

          {/* Header */}
          <div style={{ textAlign:'center', marginBottom:'72px' }}>
            <div className="label" style={{ marginBottom:'16px', color:MFG_BRIGHT }}>The Learning Experience</div>
            <h2 className="pf" style={{ fontSize:'clamp(28px,4.5vw,56px)', fontWeight:'800', letterSpacing:'-0.03em', color:'#F0EDE6', lineHeight:'1.05', marginBottom:'20px' }}>
              You don't learn alone<br /><span style={{ color:MFG_BRIGHT }}>with AI.</span>
            </h2>
          ...
          <div style={{ maxWidth:'640px', margin:'0 auto 72px' }}>
            <div style={{ display:'flex', borderRadius:'100px', overflow:'hidden', height:'10px', marginBottom:'16px' }}>
              <div style={{ width:'75%', background:`linear-gradient(90deg,${MFG},${MFG_BRIGHT})` }} />
              <div style={{ width:'25%', background:'linear-gradient(90deg,#FF6A00,#FF9A00)' }} />
            </div>
            <div style={{ display:'flex', justifyContent:'space-between' }}>
              <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
                <div style={{ width:'8px', height:'8px', borderRadius:'50%', background:MFG }} />
                <span style={{ fontFamily:'DM Mono,monospace', fontSize:'10px', color:MFG_BRIGHT, letterSpacing:'0.1em', textTransform:'uppercase' }}>75% — Maya AI Learning</span>
              </div>
              <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
                <div style={{ width:'8px', height:'8px', borderRadius:'50%', background:'#FF6A00' }} />
                <span style={{ fontFamily:'DM Mono,monospace', fontSize:'10px', color:'#FF9A00', letterSpacing:'0.1em', textTransform:'uppercase' }}>25% — Human</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid-3-auto">
            ...
            <div style={{ background:'rgba(255,255,255,0.02)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:'20px', padding:'36px', position:'relative', overflow:'hidden' }}>
              <div style={{ position:'absolute', top:0, left:0, right:0, height:'3px', background:`linear-gradient(90deg,${MFG},${MFG_BRIGHT})`, borderRadius:'20px 20px 0 0' }} />
              <div style={{ width:'48px', height:'48px', borderRadius:'12px', background:`${MFG}15`, border:`1px solid ${MFG}30`, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'22px', marginBottom:'20px' }}>✈️</div>
              <div style={{ fontFamily:'DM Mono,monospace', fontSize:'9px', color:MFG_BRIGHT, letterSpacing:'0.14em', textTransform:'uppercase', marginBottom:'10px' }}>01 · In-Person</div>
              ...
              <p style={{ fontSize:'14px', color:'#777', lineHeight:'1.75', marginBottom:'20px' }}>
                Travel with your cohort to live manufacturing hubs — factories in India, logistics centres in Singapore, and industrial corridors in the Middle East. You don't just study operations. You walk the floor.
              </p>
              <div style={{ display:'flex', flexDirection:'column', gap:'8px' }}>
                {['Mumbai — India Manufacturing Corridor', 'Singapore — Logistics & Supply Chain', 'Dubai — Middle East Industrial Hub', 'Shanghai — Smart Manufacturing'].map(city => (
                  <div key={city} style={{ display:'flex', alignItems:'center', gap:'10px' }}>
                    <div style={{ width:'5px', height:'5px', borderRadius:'50%', background:MFG, flexShrink:0 }} />
            ...
            <div style={{ background:'rgba(255,255,255,0.02)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:'20px', padding:'36px', position:'relative', overflow:'hidden' }}>
              ...
              <div style={{ fontFamily:'DM Mono,monospace', fontSize:'9px', color:'#FF9A00', letterSpacing:'0.14em', textTransform:'uppercase', marginBottom:'10px' }}>02 · Experiential</div>
              <div className="pf" style={{ fontSize:'22px', fontWeight:'700', color:'#F0EDE6', marginBottom:'14px', lineHeight:'1.2' }}>Sunday Sessions</div>
              <p style={{ fontSize:'14px', color:'#777', lineHeight:'1.75', marginBottom:'20px' }}>
                Every Sunday, your cohort comes together for a live 3-hour experiential session — case studies pulled from real plant failures, supply chain crises, and ops turnarounds. You don't analyse from the outside. You solve it as if you're inside.
              </p>
              <div style={{ display:'flex', flexDirection:'column', gap:'8px' }}>
                {['Live case studies from real plant floors', 'Simulated ops crises — solve in real time', 'Team-based problem solving with your cohort', 'Debrief with a practitioner every session'].map(point => (
            ...
            <div style={{ background:'rgba(255,255,255,0.02)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:'20px', padding:'36px', position:'relative', overflow:'hidden' }}>
              <div style={{ position:'absolute', top:0, left:0, right:0, height:'3px', background:'linear-gradient(90deg,#A855F7,#C084FC)', borderRadius:'20px 20px 0 0' }} />
              <div style={{ width:'48px', height:'48px', borderRadius:'12px', background:'rgba(168,85,247,0.1)', border:'1px solid rgba(168,85,247,0.25)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'22px', marginBottom:'20px' }}>🤝</div>
              <div style={{ fontFamily:'DM Mono,monospace', fontSize:'9px', color:'#C084FC', letterSpacing:'0.14em', textTransform:'uppercase', marginBottom:'10px' }}>03 · Industry Fundamentals</div>
              <div className="pf" style={{ fontSize:'22px', fontWeight:'700', color:'#F0EDE6', marginBottom:'14px', lineHeight:'1.2' }}>Faculty Discussions</div>
              <p style={{ fontSize:'14px', color:'#777', lineHeight:'1.75', marginBottom:'20px' }}>
                Once a week, a manufacturing leader from our program committee joins your cohort for a direct, unscripted conversation — about their career, their decisions, their mistakes. This is not a lecture. This is access.
              </p>
              <div style={{ display:'flex', flexDirection:'column', gap:'8px' }}>
                {['Plant heads, supply chain directors, ops CEOs', 'Unscripted — real decisions, real mistakes', 'Live Q&A — you ask, they answer honestly', 'Recorded and timestamped in your learning log'].map(point => (
                  <div key={point} style={{ display:'flex', alignItems:'center', gap:'10px' }}>
          ...
          {/* Bottom callout */}
          <div style={{ marginTop:'48px', padding:'32px 40px', background:`${MFG}06`, border:`1px solid ${MFG}20`, borderRadius:'16px', display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:'24px' }}>
            <div>
            ...
            <Link href="/apply" style={{ fontFamily:'DM Mono,monospace', fontSize:'11px', letterSpacing:'0.1em', textTransform:'uppercase', padding:'14px 28px', borderRadius:'8px', background:MFG, color:'#fff', textDecoration:'none', fontWeight:'600', whiteSpace:'nowrap' }}>Apply Now →</Link>
          </div>
