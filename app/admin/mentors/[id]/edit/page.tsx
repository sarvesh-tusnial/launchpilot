...
export default async function EditMentorPage({ params }: Props) {
  ...
  return (
    <div style={{ maxWidth: '640px' }}>
      <div style={{ marginBottom: '36px' }}>
        ...
        <h1 style={{ fontSize: '28px', fontWeight: '600', letterSpacing: '-0.02em' }}>Edit Mentor</h1>
      </div>
      <MentorForm mentor={mentorRes.data} competencies={ALL_COMPETENCIES} concepts={allConcepts} />
    </div>
  )
}
