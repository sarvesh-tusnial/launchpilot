  ...
  return (
    <div style={{ background:'#05050A', minHeight:'100vh', color:'#E8E6E0', fontFamily:'DM Sans,sans-serif' }}>
      ...
      <section style={{ padding:'80px 24px', background:'#05050A', borderTop:'1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth:'1160px', margin:'0 auto' }}>
          <div style={{ marginBottom:'56px' }}>
            <div className="label" style={{ marginBottom:'16px', color:BIZ }}>Program Committee</div>
            <h2 className="pf" style={{ fontSize:'clamp(28px,4.5vw,52px)', fontWeight:'800', letterSpacing:'-0.03em', color:'#F0EDE6', lineHeight:'1.1', marginBottom:'16px' }}>
              School committee backed by<br /><span style={{ color:BIZ }}>real-world leaders in business.</span>
            </h2>
            <p style={{ fontSize:'16px', color:'#888', lineHeight:'1.7', maxWidth:'580px' }}>
              Every program, competency and assessment has been designed with — and validated by — operators, investors and founders who have built, scaled and exited real businesses.
            </p>
          </div>

          <div style={{ display:'grid', gridTemplateColumns:'repeat(5,1fr)', gap:'16px' }} className="committee-grid">
            {[
              { name:'Vansh Chiripal',  role:'Associate School Director · Co-Founder, LaunchPilot ',          tag:'Tech and Business',  img:'/images/mentors/vansh-chiripal.jpg' },
              ...
              { name:'Yash Shah',        role:'GenAI Head India & SEA · AWS',                             tag:'AI & Product',     img:'/images/mentors/yash-shah.jpg' },
              { name:'Andrew Chow',      role:'Co-Founder, Asia Pro Ventures · NTU',                      tag:'Ventures',         img:'/images/mentors/andrew-chow.jpg' },
              { name:'Daniel Ling',      role:'ex-VP Design, Lazada & DBS · NUS',                        tag:'Growth & Design',  img:'/images/mentors/daniel-ling.jpg' },
              { name:'Shavin Goswami',   role:'Global Risk Ops, Meta · ex-EY Consulting',                tag:'Operations',       img:'/images/mentors/shavin-goswami.jpg' },
              ...
              <div key={m.name} style={{ display:'flex', flexDirection:'column', alignItems:'center', textAlign:'center', gap:'12px' }}>
                <div style={{ width:'88px', height:'88px', borderRadius:'50%', overflow:'hidden', border:`2px solid ${BIZ}30`, background:`${BIZ}10`, flexShrink:0 }}>
                  <img src={m.img} alt={m.name} style={{ width:'100%', height:'100%', objectFit:'cover', objectPosition:'center top', display:'block' }} />
                </div>
                <div style={{ fontFamily:'DM Mono,monospace', fontSize:'8px', letterSpacing:'0.14em', textTransform:'uppercase', color:BIZ, background:`${BIZ}12`, border:`1px solid ${BIZ}25`, padding:'3px 10px', borderRadius:'100px' }}>{m.tag}</div>
      ...
      <section style={{ padding:'100px 24px', background:'#060608', borderTop:'1px solid rgba(255,255,255,0.05)', position:'relative', overflow:'hidden' }}>
        <div style={{ position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)', width:'700px', height:'500px', background:`radial-gradient(ellipse,rgba(255,106,0,0.06) 0%,transparent 65%)`, pointerEvents:'none' }} />
        <div style={{ maxWidth:'1160px', margin:'0 auto', position:'relative' }}>

          <div style={{ textAlign:'center', marginBottom:'72px' }}>
            <div className="label" style={{ marginBottom:'16px', color:BIZ }}>The Learning Experience</div>
            <h2 className="pf" style={{ fontSize:'clamp(28px,4.5vw,56px)', fontWeight:'800', letterSpacing:'-0.03em', color:'#F0EDE6', lineHeight:'1.05', marginBottom:'20px' }}>
              You don't learn alone<br /><span style={{ color:BIZ }}>with AI.</span>
            </h2>
          ...
          <div style={{ maxWidth:'640px', margin:'0 auto 72px' }}>
            <div style={{ display:'flex', borderRadius:'100px', overflow:'hidden', height:'10px', marginBottom:'16px' }}>
              <div style={{ width:'75%', background:`linear-gradient(90deg,${BIZ},#FF9A00)` }} />
              <div style={{ width:'25%', background:'linear-gradient(90deg,#7C3AED,#A855F7)' }} />
            </div>
            <div style={{ display:'flex', justifyContent:'space-between' }}>
              <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
                <div style={{ width:'8px', height:'8px', borderRadius:'50%', background:BIZ }} />
                <span style={{ fontFamily:'DM Mono,monospace', fontSize:'10px', color:BIZ, letterSpacing:'0.1em', textTransform:'uppercase' as const }}>75% — Maya AI Learning</span>
              </div>
              <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
          ...
          <div className="grid-3-auto">
            ...
            <div style={{ background:'rgba(255,255,255,0.02)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:'20px', padding:'36px', position:'relative', overflow:'hidden' }}>
              <div style={{ position:'absolute', top:0, left:0, right:0, height:'3px', background:`linear-gradient(90deg,${BIZ},#FF9A00)`, borderRadius:'20px 20px 0 0' }} />
              <div style={{ width:'48px', height:'48px', borderRadius:'12px', background:`rgba(255,106,0,0.1)`, border:`1px solid rgba(255,106,0,0.25)`, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'22px', marginBottom:'20px' }}>✈️</div>
              <div style={{ fontFamily:'DM Mono,monospace', fontSize:'9px', color:BIZ, letterSpacing:'0.14em', textTransform:'uppercase' as const, marginBottom:'10px' }}>01 · In-Person</div>
              ...
              <p style={{ fontSize:'14px', color:'#777', lineHeight:'1.75', marginBottom:'20px' }}>
                Travel with your cohort to the startup and business hubs that matter — Singapore for investor networks, San Francisco for tech and AI, Dubai for regional expansion. You study markets from inside them.
              </p>
              <div style={{ display:'flex', flexDirection:'column', gap:'8px' }}>
                {['Singapore — Investor & Startup Ecosystem','San Francisco — Tech, AI & Venture','Dubai — Middle East Business Expansion','Mumbai — India Growth & Distribution'].map(city => (
                  <div key={city} style={{ display:'flex', alignItems:'center', gap:'10px' }}>
                    <div style={{ width:'5px', height:'5px', borderRadius:'50%', background:BIZ, flexShrink:0 }} />
            ...
            <div style={{ background:'rgba(255,255,255,0.02)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:'20px', padding:'36px', position:'relative', overflow:'hidden' }}>
              ...
              <p style={{ fontSize:'14px', color:'#777', lineHeight:'1.75', marginBottom:'20px' }}>
                Every Sunday, your cohort meets live for a 3-hour experiential session — real GTM crises, failed product launches, fundraising breakdowns. You don't analyse from the outside. You solve it as if you're the founder.
              </p>
              <div style={{ display:'flex', flexDirection:'column', gap:'8px' }}>
                {['Live cases from real startup failures & wins','Simulated GTM and product crises — solve in real time','Team-based problem solving with your cohort','Debrief with a practitioner every session'].map(point => (
            ...
            <div style={{ background:'rgba(255,255,255,0.02)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:'20px', padding:'36px', position:'relative', overflow:'hidden' }}>
              <div style={{ position:'absolute', top:0, left:0, right:0, height:'3px', background:'linear-gradient(90deg,#0D9488,#2DD4BF)', borderRadius:'20px 20px 0 0' }} />
              <div style={{ width:'48px', height:'48px', borderRadius:'12px', background:'rgba(13,148,136,0.1)', border:'1px solid rgba(13,148,136,0.25)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'22px', marginBottom:'20px' }}>🤝</div>
              <div style={{ fontFamily:'DM Mono,monospace', fontSize:'9px', color:'#2DD4BF', letterSpacing:'0.14em', textTransform:'uppercase' as const, marginBottom:'10px' }}>03 · Business Fundamentals</div>
              ...
              <p style={{ fontSize:'14px', color:'#777', lineHeight:'1.75', marginBottom:'20px' }}>
                Once a week, a business leader from our committee joins your cohort for a direct, unscripted conversation — their decisions, their failures, what they'd do differently. This is not a lecture. This is access.
              </p>
              <div style={{ display:'flex', flexDirection:'column', gap:'8px' }}>
                {['Founders, PMs, investors and growth leaders','Unscripted — real decisions, real mistakes','Live Q&A — you ask, they answer honestly','Recorded and timestamped in your learning log'].map(point => (
                  <div key={point} style={{ display:'flex', alignItems:'center', gap:'10px' }}>
                    <div style={{ width:'5px', height:'5px', borderRadius:'50%', background:'#0D9488', flexShrink:0 }} />
                    <span style={{ fontSize:'12px', color:'#666' }}>{point}</span>
                  </div>
                ))}
              </div>
          ...
          {/* Bottom callout */}
          <div style={{ marginTop:'48px', padding:'32px 40px', background:'rgba(255,106,0,0.05)', border:'1px solid rgba(255,106,0,0.15)', borderRadius:'16px', display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:'24px' }}>
            <div>
            ...
            <Link href="/apply" style={{ fontFamily:'DM Mono,monospace', fontSize:'11px', letterSpacing:'0.1em', textTransform:'uppercase' as const, padding:'14px 28px', borderRadius:'8px', background:BIZ, color:'#fff', textDecoration:'none', fontWeight:'600', whiteSpace:'nowrap' as const }}>Apply Now →</Link>
          </div>
